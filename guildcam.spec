...
#
# PyInstaller spec for GuildCAM — ONE-FOLDER build.
# Build:  python -m PyInstaller guildcam.spec --clean --noconfirm
# Output: dist/GuildCAM/GuildCAM.exe  (one-folder, Windows)
#
# This is the build the Inno Setup installer (installer/GuildCAM.iss) packages.
...
a = Analysis(
    ["main.py"],
    pathex=["src"],             # src-layout: import guildcam from source
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    noarchive=False,
