"""Layer vocabulary: single source of truth for all GuildCAM layer names and styles.

GuildDraw exports layers; GuildCAM consumes them.  All layer-name strings and
...
Layer contract (GuildDraw → GuildCAM):
...
# Every layer name GuildCAM will import (others are logged as unrecognised)
