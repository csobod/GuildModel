...
never drifts) merged with the maker's own presets in ``~/.guildmodel/frame_styles.yaml``
...
skin, allowance). It **seeds** a new frame; the ``.gmodel`` still stores the frame's
...
_USER = pathlib.Path.home() / ".guildmodel" / "frame_styles.yaml"
